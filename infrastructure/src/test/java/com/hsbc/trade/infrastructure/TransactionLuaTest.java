...
import com.hsbc.trade.infrastructure.gateway.impl.CacheRepositoryImpl;
...
public class TransactionLuaTest extends BaseTest {
    ...
    public void sourceAccountNotExistTest() {
        ...
        transactionDomainService.process(transactionEntity);
    }
    ...
    @Test
    @SneakyThrows
    public void preLoadAccountInfoTest() {
        cacheRepositoryImpl.loadHotAccountInfo2Cache();
    }
}
